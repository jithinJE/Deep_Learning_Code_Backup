...
if __name__=='__main__':
    ...
    description = 'multiple_lstm_nosmooth'
    ...
    for seq_len in seq_lens:
        ...
        if (single_branch):
            ...
            model = KerasRegressor(build_fn=multiple_branch_lstm.build_model, validation_split = 0.20)
        cnn_layers = [3]
        filter_nums=[128]
        batch_size = [32]
        single_lstm = [True]
        ...
        for index, row in results.iterrows():
            ...
            if (single_branch):
                ...
                top_model = multiple_branch_lstm.build_model(row['param_layers'], row['param_ksize1'], row['param_step_size'], row['param_lstm_units'], row['param_single_lstm_layer'])
